...
#subsetting common genes between sarcomere gene list and sample genes
...
##converting extracted subset to dataframe
...
#adding new column to sample table for phases of maturation
...
#subsetting common genes between mitochondria gene list and sample genes
...
#subsetting common genes between cell cycle gene list and sample genes
...
#sorting differentially expressed genes on q value and extracting top 1000 genes
...
#creating heatmap
pheatmap(as.matrix(top_1000[,-1]), scale = "row",show_rownames = F, labels_col = c("P0_1","P0_2","Ad_1","Ad_2","P4_1","P4_2","P7_1","P7_2"))
